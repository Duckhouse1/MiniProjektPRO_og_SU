...
class DagligSkaevTest {
    ...
    void doegnDosis() {
        ...
        DagligSkaev dskæv2 = new DagligSkaev(l1, LocalDate.of(2024,03,22),LocalDate.of(2024,03,22));

        assertThrows(RuntimeException.class,() -> dskæv2.opretDosis(LocalTime.of(13, 30), 0));
